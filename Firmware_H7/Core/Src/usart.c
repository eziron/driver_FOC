...
void MX_UART5_Init(void)
{
  ...
  huart5.AdvancedInit.DataInvert = UART_ADVFEATURE_DATAINV_ENABLE;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC12     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = SPORT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(SPORT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, UART_RX_Pin|UART_TX_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PC12     ------> UART5_TX
    */
    HAL_GPIO_DeInit(SPORT_GPIO_Port, SPORT_Pin);
